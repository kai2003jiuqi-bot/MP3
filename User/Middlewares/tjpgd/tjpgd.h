/* 来源: ChaN's TJpgDec v0.01d */
/* 配置: RGB565输出 + 缩放支持 */
/* 注意: 不支持 Progressive JPEG, 仅 Baseline JPEG */
...
/* Default config: RGB565 output with scaling enabled, no RT-Thread */
#ifndef UNSUPPORT_RT_THRED
#define UNSUPPORT_RT_THRED
#endif
#define rt_inline inline

#ifndef TJPGD_USING_FORMAT_RGB565
#define TJPGD_USING_FORMAT_RGB565
#endif
#ifndef TJPGD_USING_SCALE
#define TJPGD_USING_SCALE
#endif
#ifndef TJPGD_INPUT_BUFFER_SIZE
#define TJPGD_INPUT_BUFFER_SIZE  512
#endif
#ifndef TJPGD_USING_TBLCLIP
